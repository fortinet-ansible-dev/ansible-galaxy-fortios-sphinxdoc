...
.. raw:: html
    ...
    <li><span class="li-head">selector</span> - Action taken in FortiOS appliance. <span class="li-normal">type: str</span> <span class="li-required">choices:</span></li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">username</span> - User name. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">ip</span> - User IP address. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">ip_version</span> - IP version [ip4|ip6]. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">server</span> - Name of an existing LDAP server entry. If supplied, authenticate that user against any matched groups on that LDAP server. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mac</span> - Single MAC to block. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">uid</span> - Single FortiClient UID to block. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">password</span> - Registration password to test. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mkey</span> - Name of the IKE gateway to clear. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mac</span> - Single MAC to deregister. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">uid</span> - Single FortiClient UID to deregister. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">raid</span> - RAID level [Raid-0|Raid-1|Raid-5|Raid-10]. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">count</span> - Number of keys to be generated [1-512]. <span class="li-normal">type: int </span> </li>
                <li><span class="li-required">prefix</span> - Prefix to be added at the start of the generated key's name. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">group</span> - Multi pre-shared key group to add keys to. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">key_length</span> - Length of the keys to be generated [8-63]. <span class="li-normal">type: int </span> </li>
                <li><span class="li-required">mpsk_profile</span> - Multi pre-shared key profile to add keys to. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">serials</span> - FortiAP IDs to turn LED blink on/off. <span class="li-normal">type: array </span> </li>
                <li><span class="li-required">duration</span> - Time to blink, in seconds. 0 or omit for indefinite. <span class="li-normal">type: int </span> </li>
                <li><span class="li-required">blink</span> - True to turn on blinking, false to turn off. <span class="li-normal">type: boolean </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">sms_server</span> - The SMS server to be used for sending SMS messages, required if "custom" SMS method is chosen. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">vpn_name</span> - The name of the VPN configuration. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">phone_user_list</span> - The user that the VPN configuration SMS should be sent to. At least one of "phone_user_list" or "phone_number_list" is required if "method" is "sms". <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">method</span> - Method to send [email|sms]. If not set, email will be the default. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">email_list</span> - The email address that the VPN configuration message should be sent to. Required if "method" is "email". <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">host</span> - The hostname/IP address of the VPN server. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">sms_method</span> - The method to be used for sending the SMS [fortiguard|custom]. Default is "fortiguard". <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">port</span> - The port of the VPN server. <span class="li-normal">type: int </span> </li>
                <li><span class="li-required">phone_number_list</span> - The phone number that the VPN configuration SMS should be sent to. At least one of "phone_user_list" or "phone_number_list" is required if "method" is "sms". <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mac</span> - Single MAC to quarantine. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">uid</span> - Single FortiClient UID to quarantine. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">value</span> - PEM formatted certificate. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">last_update_time</span> - Timestamp of a previous update request. If this is not provided then it will refresh the Azure application list data. <span class="li-normal">type: int </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">macs</span> - An array of host MAC addresses to be removed. <span class="li-normal">type: array </span> </li>
        ...
        <ul class="ul-self">
                ...
                <li><span class="li-required">auth_type</span> - Authentication protocol to use [auto|ms_chap_v2|ms_chap|chap|pap]. If 'mkey' is provided, this overrides the 'auth-type' value in the object. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mac</span> - Single MAC to unblock. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">uid</span> - Single FortiClient UID to unblock. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">mac</span> - Single MAC to unquarantine. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">uid</span> - Single FortiClient UID to unquarantine. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                ...
                <li><span class="li-required">fswname</span> - Filter: FortiSwitch ID. `mkey` should be used instead. <span class="li-normal">type: string </span> </li>
        ...
        <ul class="ul-self">
                <li><span class="li-required">file_content</span> - Provided when uploading a file: base64 encoded file data. Must not contain whitespace or other invalid base64 characters. Must be included in HTTP body. <span class="li-normal">type: string </span> </li>
                <li><span class="li-required">filename</span> - Name of PAC file. <span class="li-normal">type: string </span> </li>

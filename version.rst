...
+---------------+---------------------+----------------+-----------------------------------------------------------------+
| unified       | 2.4.1               | 2025/9/26      | ``ansible-galaxy collection install fortinet.fortios:2.4.1``    |
+---------------+---------------------+----------------+-----------------------------------------------------------------+
| unified       | 2.4.2               | 2025/10/24     | ``ansible-galaxy collection install fortinet.fortios:2.4.2``    |
+---------------+---------------------+----------------+-----------------------------------------------------------------+
| unified       | 2.5.0               | 2026/2/25      | ``ansible-galaxy collection install fortinet.fortios:2.5.0``    |
+---------------+---------------------+----------------+-----------------------------------------------------------------+
| unified       | 2.5.1               | 2026/4/15      | ``ansible-galaxy collection install fortinet.fortios:2.5.1``    |
+---------------+---------------------+----------------+-----------------------------------------------------------------+
| unified       | 2.6.0 ``latest``    | 2026/8/17      | ``ansible-galaxy collection install fortinet.fortios:2.6.0``    |
+---------------+---------------------+----------------+-----------------------------------------------------------------+

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">internal_allowaccess</span> - Allowed access on the switch internal interface. <span class="li-normal">type: list</span> <span class="li-normal">choices: https, ping, ssh, snmp, http, telnet, radius_acct</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mgmt_allowaccess</span> - Allowed access on the switch management interface. <span class="li-normal">type: list</span> <span class="li-normal">choices: https, ping, ssh, snmp, http, telnet, radius_acct</span>

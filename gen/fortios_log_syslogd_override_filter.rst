...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify log_syslogd feature and override_filter category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd_override_filter</span> - Override filters for remote system server. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">filter</span> - Syslog filter. <span class="li-normal">type: str</span></li>

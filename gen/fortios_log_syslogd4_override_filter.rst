...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify log_syslogd4 feature and override_filter category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd4_override_filter</span> - Override filters for remote system server. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">filter</span> - Syslog 4 filter. <span class="li-normal">type: str</span></li>

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">wanopt_passive_opt</span> - WAN optimization passive mode options. This option decides what IP address will be used to connect to server. <span class="li-normal">type: str</span> <span class="li-normal">choices: default, transparent, non_transparent</span>

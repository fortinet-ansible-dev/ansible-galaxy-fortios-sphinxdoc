...
.. _fortios_system_central_management:
...
.. raw:: html
    ...
    <li><span class="li-head">system_central_management</span> - Configure central management. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">
            ...
            <li><span class="li-head">server_list</span> - Additional servers that the FortiGate can use for updates (for AV, IPS, updates) and ratings (for web filter and antispam ratings) servers. <span class="li-normal">type: list</span></li>
                    <ul class="ul-self">

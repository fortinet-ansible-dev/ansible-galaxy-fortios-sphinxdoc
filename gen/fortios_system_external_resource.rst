...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">threat_feed_hash_mode</span> - Configure use of the external threat feed as either a hash database or plain text database . <span class="li-normal">type: str</span> <span class="li-normal">choices: hash-db, plain-text-db</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">update_method</span> - External resource update method. <span class="li-normal">type: str</span> <span class="li-normal">choices: feed, push, fortimq</span>

...
.. raw:: html
    ...
    <li> <span class="li-head">system_dns</span> - Configure DNS. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">primary</span> - Primary DNS server IP address, default is FortiGuard server at 208.81.112.53. <span class="li-normal">type: str</span></li>
        <li> <span class="li-head">secondary</span> - Secondary DNS server IP address, default is FortiGuard server at 208.81.112.52. <span class="li-normal">type: str</span></li>

:source: fortios_firewall_custom_tag.py

:orphan:

.. fortios_firewall_custom_tag:
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify firewall feature and custom_tag category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_custom_tag</span> - Define custom tag table. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">abbreviation</span> - Custom tag name abbreviation. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">color</span> - Color of the custom tag on the GUI. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">name</span> - Custom tag name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>

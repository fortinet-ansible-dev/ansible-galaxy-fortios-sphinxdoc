...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify log_fortianalyzer_cloud feature and override_setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">log_fortianalyzer_cloud_override_setting</span> - Override FortiAnalyzer Cloud settings. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">

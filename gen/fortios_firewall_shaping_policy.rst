...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify firewall feature and shaping_policy category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_shaping_policy</span> - Configure shaping policies. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">class_id</span> - Traffic class ID. Source firewall.traffic-class.class-id. <span class="li-normal">type: int</span></li>
        ...
        <li> <span class="li-head">internet_service_name</span> - Internet Service ID. <span class="li-normal">type: list</span></li>
            <ul class="ul-self">
        ...
        fortios_firewall_shaping_policy:
          ...
          firewall_shaping_policy:
            ...
            internet_service_name:
             -
                name: "default_name_32 (source firewall.internet-service-name.name)"

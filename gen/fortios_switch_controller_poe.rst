...
-----------------------------
Supported Version Ranges: v6.2.0, v6.2.5 -> v6.2.7, v6.4.1
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_poe</span> - List PoE end-points status. <span class="li-normal">type: dict</span>

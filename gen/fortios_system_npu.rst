...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mcast_session_accounting</span> - Enable/disable traffic accounting for each multicast session through TAE counter. <span class="li-normal">type: str</span> <span class="li-normal">choices: tpe_based, session_based, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">qos_mode</span> - QoS mode on switch and NP. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, priority, round_robin</span>
      ...
      - name: Configure NPU attributes.
        fortios_system_npu:
          ...
          system_npu:
            ...
            mcast_session_accounting: "tpe_based"
            port_cpu_map:
             -

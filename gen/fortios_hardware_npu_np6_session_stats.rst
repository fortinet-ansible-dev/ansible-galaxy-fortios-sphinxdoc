:source: fortios_hardware_npu_np6_session_stats.py
...
.. raw:: html
    ...
    <li> <span class="li-head">hardware_npu_np6_session_stats</span> - Show NP6 session offloading statistics counters. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>hardware_npu_np6_session_stats</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">dev_id</span> - NP6 ID <span class="li-normal">type: str</span>

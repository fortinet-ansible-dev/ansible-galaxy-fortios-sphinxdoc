...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">db_mode</span> - Behaviour when the maximum size is reached. <span class="li-normal">type: str</span> <span class="li-normal">choices: stop_adding, remove_modified_then_oldest, remove_oldest</span>

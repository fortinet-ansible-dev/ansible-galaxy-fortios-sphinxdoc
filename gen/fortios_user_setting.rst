...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">auth_ssl_min_proto_version</span> - Minimum supported protocol version for SSL/TLS connections . <span class="li-normal">type: str</span> <span class="li-normal">choices: default, SSLv3, TLSv1, TLSv1_1, TLSv1_2</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">auth_timeout_type</span> - Control if authenticated users have to login again after a hard timeout, after an idle timeout, or after a session timeout. <span class="li-normal">type: str</span> <span class="li-normal">choices: idle_timeout, hard_timeout, new_session</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">radius_ses_timeout_act</span> - Set the RADIUS session timeout to a hard timeout or to ignore RADIUS server session timeouts. <span class="li-normal">type: str</span> <span class="li-normal">choices: hard_timeout, ignore_timeout</span>
      ...
      - name: Configure user authentication setting.
        fortios_user_setting:
          ...
          user_setting:
            ...
            auth_timeout: "20"
            auth_timeout_type: "idle_timeout"
            auth_type: "http"
            per_policy_disclaimer: "enable"
            radius_ses_timeout_act: "hard_timeout"

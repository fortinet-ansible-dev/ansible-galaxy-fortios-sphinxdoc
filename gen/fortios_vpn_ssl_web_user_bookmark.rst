...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ssl_web_user_bookmark</span> - Configure SSL VPN user bookmark. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">bookmarks</span> - Bookmark table. <span class="li-normal">type: list</span></li>
            ...
            <li> <span class="li-head">server_layout</span> - Server side keyboard layout. <span class="li-normal">type: str</span> <span class="li-normal">choices: en-us-qwerty, de-de-qwertz, fr-fr-azerty, it-it-qwerty, sv-se-qwerty, failsafe</span></li>

...
.. _fortios_system_vdom_radius_server:
...
.. raw:: html
    ...
    <li><span class="li-head">system_vdom_radius_server</span> - Configure a RADIUS server to use as a RADIUS Single Sign On (RSSO) server for this VDOM. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">name</span> - Name of the VDOM that you are adding the RADIUS server to. Source system.vdom.name. <span class="li-required">required</span> <span class="li-normal">type: str</span></li>

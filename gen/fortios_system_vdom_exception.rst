...
.. _fortios_system_vdom_exception:
...
.. raw:: html
    ...
    <li><span class="li-head">system_vdom_exception</span> - Global configuration objects that can be configured independently for all VDOMs or for the defined VDOM scope. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">id</span> - Index <1-4096>. <span class="li-required">required</span> <span class="li-normal">type: int</span></li>
            <li><span class="li-head">object</span> - Name of the configuration object that can be configured independently for all VDOMs. <span class="li-normal">type: str</span> <span class="li-normal">choices: log.fortianalyzer.setting,  log.fortianalyzer.override-setting</span></li>
            <li><span class="li-head">oid</span> - Object ID. <span class="li-normal">type: int</span></li>
            ...
            <li><span class="li-head">vdom</span> - Names of the VDOMs. <span class="li-normal">type: list</span></li>
                    ...
                    <li><span class="li-head">name</span> - VDOM name. Source system.vdom.name. <span class="li-required">required</span> <span class="li-normal">type: str</span>
                    </ul>

...
.. raw:: html
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">id</span> - Security group tag (1 - 65535). <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
      ...
      - name: Configure IPv4/IPv6 policies.
        fortios_firewall_policy:
          ...
          firewall_policy:
            ...
            dstaddr:
             -
                name: "default_name_40 (source firewall.address.name firewall.addrgrp.name firewall.vip.name firewall.vipgrp.name system.external-resource.name)"
            ...
            dstintf:
             -
                name: "default_name_45 (source system.interface.name system.zone.name system.sdwan.zone.name)"
            ...
            fsso_groups:
             -
                name: "default_name_56 (source user.adgrp.name)"
            geoip_anycast: "enable"
            geoip_match: "physical-location"
            global_label: "<your_own_value>"
            groups:
             -
                name: "default_name_61 (source user.group.name)"
            ...
            internet_service_id:
             -
                id:  "76 (source firewall.internet-service.id)"
            ...
            internet_service_src_id:
             -
                id:  "88 (source firewall.internet-service.id)"
            ...
            poolname:
             -
                name: "default_name_121 (source firewall.ippool.name)"
            poolname6:
             -
                name: "default_name_123 (source firewall.ippool6.name)"
            ...
            reputation_minimum: "131 (source firewall.internet-service-reputation.id)"
            rsso: "enable"
            rtp_addr:
             -
                name: "default_name_134 (source firewall.internet-service-custom-group.name firewall.addrgrp.name)"
            rtp_nat: "disable"
            ...
            service:
             -
                name: "default_name_142 (source firewall.service.custom.name firewall.service.group.name)"
            ...
            src_vendor_mac:
             -
                id:  "150 (source firewall.vendor-mac.id)"
            srcaddr:
             -
                name: "default_name_152 (source firewall.address.name firewall.addrgrp.name system.external-resource.name)"
            srcaddr_negate: "enable"
            srcaddr6:
             -
                name: "default_name_155 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
            srcintf:
             -
                name: "default_name_157 (source system.interface.name system.zone.name system.sdwan.zone.name)"
            ssh_filter_profile: "<your_own_value> (source ssh-filter.profile.name)"
            ssh_policy_redirect: "enable"
            ssl_mirror: "enable"
            ssl_mirror_intf:
             -
                name: "default_name_162 (source system.interface.name system.zone.name)"
            ssl_ssh_profile: "<your_own_value> (source firewall.ssl-ssh-profile.name)"
            status: "enable"
            tcp_mss_receiver: "165"
            tcp_mss_sender: "166"
            ...
            users:
             -
                name: "default_name_177 (source user.local.name)"
            utm_status: "enable"
            uuid: "<your_own_value>"
            ...
            ztna_ems_tag:
             -
                name: "default_name_200 (source firewall.address.name firewall.addrgrp.name)"
            ztna_geo_tag:
             -
                name: "default_name_202 (source firewall.address.name firewall.addrgrp.name)"
            ztna_status: "enable"

...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">fabric_policy</span> - Fabric policy related attributes. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">from</span> - From device. Source system.csf.trusted-list.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">to</span> - To device. Source system.csf.trusted-list.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.0.11</code></td>
        ...
        <li> <span class="li-head">llm_profile</span> - Name of an existing LLM profile. Source llm.profile.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">permit_any_host</span> - Enable/disable fullcone NAT. Accept UDP packets from any host. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>saml_server</td>
 <td><code class="docutils literal notranslate">v7.6.4 -> v7.6.4 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v7.0.1 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">skip_vrf_match</span> - Enable/disable skipping VRF matching on reply direction. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7</code></td>
        ...
        <li> <span class="li-head">ztna_destination</span> - Configure ZTNA destinations. Must be used with ZTNA traffic-forward-proxy. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ztna_destination:name</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - ZTNA destination name. Source ztna.destination.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">ztna_ems_tag6</span> - Source ZTNA FortiClient EMS tag IPv6 names. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ztna_ems_tag6:name</span>

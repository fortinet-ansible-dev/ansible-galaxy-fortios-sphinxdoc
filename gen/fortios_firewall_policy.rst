...
.. raw:: html
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">id</span> - Security group tag. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
        ...
        fortios_firewall_policy:
          ...
          firewall_policy:
            ...
            internet_service_src_custom_group:
             -
                name: "default_name_83 (source firewall.internet-service-custom-group.name)"
            ...
            poolname:
             -
                name: "default_name_120 (source firewall.ippool.name)"
            poolname6:
             -
                name: "default_name_122 (source firewall.ippool6.name)"
            ...
            reputation_minimum: "130 (source firewall.internet-service-reputation.id)"
            rsso: "enable"
            rtp_addr:
             -
                name: "default_name_133 (source firewall.address.name firewall.addrgrp.name)"
            rtp_nat: "disable"
            ...
            service:
             -
                name: "default_name_141 (source firewall.service.custom.name firewall.service.group.name)"
            ...
            src_vendor_mac:
             -
                id:  "149 (source firewall.vendor-mac.id)"
            srcaddr:
             -
                name: "default_name_151 (source firewall.address.name firewall.addrgrp.name)"
            srcaddr_negate: "enable"
            srcaddr6:
             -
                name: "default_name_154 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
            srcintf:
             -
                name: "default_name_156 (source system.interface.name system.zone.name)"
            ssh_filter_profile: "<your_own_value> (source ssh-filter.profile.name)"
            ssh_policy_redirect: "enable"
            ssl_mirror: "enable"
            ssl_mirror_intf:
             -
                name: "default_name_161 (source system.interface.name system.zone.name)"
            ssl_ssh_profile: "<your_own_value> (source firewall.ssl-ssh-profile.name)"
            status: "enable"
            tcp_mss_receiver: "164"
            tcp_mss_sender: "165"
            ...
            users:
             -
                name: "default_name_176 (source user.local.name)"
            utm_status: "enable"
            uuid: "<your_own_value>"
            ...
            ztna_geo_tag:
             -
                name: "default_name_201 (source firewall.address.name firewall.addrgrp.name)"
            ztna_status: "enable"

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">dstaddr_negate</span> - When enabled dstaddr/dstaddr6 specifies what the destination address must NOT be. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">srcaddr_negate</span> - When enabled srcaddr/srcaddr6 specifies what the source address must NOT be. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
      ...
      - name: Configure IPv4/IPv6 policies.
        fortios_firewall_policy:
          ...
          firewall_policy:
            ...
            dstaddr:
             -
                name: "default_name_41 (source firewall.address.name firewall.addrgrp.name firewall.vip.name firewall.vipgrp.name system.external-resource.name)"
            dstaddr_negate: "enable"
            dstaddr6:
             -
                name: "default_name_44 (source firewall.address6.name firewall.addrgrp6.name firewall.vipgrp6.name firewall.vip6.name system.external-resource
                  .name)"
            dstintf:
             -
                name: "default_name_46 (source system.interface.name system.zone.name system.sdwan.zone.name)"
            ...
            fsso_groups:
             -
                name: "default_name_57 (source user.adgrp.name)"
            geoip_anycast: "enable"
            geoip_match: "physical-location"
            global_label: "<your_own_value>"
            groups:
             -
                name: "default_name_62 (source user.group.name)"
            ...
            internet_service_custom:
             -
                name: "default_name_71 (source firewall.internet-service-custom.name)"
            internet_service_custom_group:
             -
                name: "default_name_73 (source firewall.internet-service-custom-group.name)"
            internet_service_group:
             -
                name: "default_name_75 (source firewall.internet-service-group.name)"
            internet_service_id:
             -
                id:  "77 (source firewall.internet-service.id)"
            ...
            internet_service_src_custom:
             -
                name: "default_name_83 (source firewall.internet-service-custom.name)"
            internet_service_src_custom_group:
             -
                name: "default_name_85 (source firewall.internet-service-custom-group.name)"
            internet_service_src_group:
             -
                name: "default_name_87 (source firewall.internet-service-group.name)"
            internet_service_src_id:
             -
                id:  "89 (source firewall.internet-service.id)"
            internet_service_src_name:
             -
                name: "default_name_91 (source firewall.internet-service-name.name)"
            ...
            poolname:
             -
                name: "default_name_124 (source firewall.ippool.name)"
            poolname6:
             -
                name: "default_name_126 (source firewall.ippool6.name)"
            ...
            reputation_minimum: "134 (source firewall.internet-service-reputation.id)"
            rsso: "enable"
            rtp_addr:
             -
                name: "default_name_137 (source firewall.internet-service-custom-group.name firewall.addrgrp.name)"
            rtp_nat: "disable"
            ...
            service:
             -
                name: "default_name_145 (source firewall.service.custom.name firewall.service.group.name)"
            ...
            src_vendor_mac:
             -
                id:  "153 (source firewall.vendor-mac.id)"
            srcaddr:
             -
                name: "default_name_155 (source firewall.address.name firewall.addrgrp.name system.external-resource.name)"
            srcaddr_negate: "enable"
            srcaddr6:
             -
                name: "default_name_158 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
            srcintf:
             -
                name: "default_name_160 (source system.interface.name system.zone.name system.sdwan.zone.name)"
            ssh_filter_profile: "<your_own_value> (source ssh-filter.profile.name)"
            ssh_policy_redirect: "enable"
            ssl_mirror: "enable"
            ssl_mirror_intf:
             -
                name: "default_name_165 (source system.interface.name system.zone.name)"
            ssl_ssh_profile: "<your_own_value> (source firewall.ssl-ssh-profile.name)"
            status: "enable"
            tcp_mss_receiver: "168"
            tcp_mss_sender: "169"
            ...
            users:
             -
                name: "default_name_180 (source user.local.name)"
            utm_status: "enable"
            uuid: "<your_own_value>"
            ...
            ztna_ems_tag:
             -
                name: "default_name_203 (source firewall.address.name firewall.addrgrp.name)"
            ztna_geo_tag:
             -
                name: "default_name_205 (source firewall.address.name firewall.addrgrp.name)"
            ztna_status: "enable"

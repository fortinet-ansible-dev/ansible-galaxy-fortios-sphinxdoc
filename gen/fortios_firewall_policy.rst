      ...
      - name: Configure IPv4 policies.
        fortios_firewall_policy:
          ...
          firewall_policy:
            ...
            rtp_addr:
             -
                name: "default_name_130 (source firewall.address.name firewall.addrgrp.name)"
            rtp_nat: "disable"
            ...
            service:
             -
                name: "default_name_137 (source firewall.service.custom.name firewall.service.group.name)"
            ...
            srcaddr:
             -
                name: "default_name_144 (source firewall.address.name firewall.addrgrp.name)"
            srcaddr_negate: "enable"
            srcaddr6:
             -
                name: "default_name_147 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
            srcintf:
             -
            ...
            ztna_ems_tag:
             -
                name: "default_name_192 (source firewall.address.name firewall.addrgrp.name)"
            ztna_geo_tag:
             -

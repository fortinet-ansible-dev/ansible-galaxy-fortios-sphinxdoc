...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">set_80211mc_mode</span> - Set 802.11mc mode of the AP . <span class="li-normal">type: str</span> <span class="li-normal">choices: auto, initiator, responder</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert</span> - Enable/disable AP local auto cert configuration . <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_auto_regen_days</span> - Number of days to wait before expiry of an updated local certificate is requested (0 = disabled) . <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>apcfg_auto_cert_auto_regen_days</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_crypto_algo</span> - Cryptography algorithm: rsa-1024, rsa-1536, rsa-2048, rsa-4096, ec-secp256r1, ec-secp384r1, ec-secp521r1  <span class="li-normal">type: str</span> <span class="li-normal">choices: rsa-1024, rsa-1536, rsa-2048, rsa-4096, ec-secp256r1, ec-secp384r1, ec-secp521r1</span>
 ...
 <tr>
 <td>apcfg_auto_cert_crypto_algo</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[rsa-1024]</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_enroll_protocol</span> - Certificate enrollment protocol <span class="li-normal">type: str</span> <span class="li-normal">choices: none, est, scep</span>
 ...
 <tr>
 <td>apcfg_auto_cert_enroll_protocol</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[none]</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_est_ca_id</span> - CA identifier of the CA server for signing via EST. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_ca_id</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_http_password</span> - HTTP Authentication password for signing via EST. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_http_password</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_http_username</span> - HTTP Authentication username for signing via EST. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_http_username</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_https_ca</span> - PEM format https CA Certificate. Source vpn.certificate.ca.name. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_https_ca</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_server</span> - Address and port for EST server (e.g. https://example.com:1234). <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_server</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_subject</span> - Subject e.g. "CN=User,DC=example,DC=COM" <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_subject</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_est_subject_alt_name</span> - Subject alternative name (optional, e.g. "DNS:dns1.com,IP:192.168.1.99") <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_est_subject_alt_name</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_ca_id</span> - CA identifier of the CA server for signing via SCEP. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_ca_id</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_ec_name</span> - Elliptic curve name: secp256r1, secp384r1 and secp521r1. . <span class="li-normal">type: str</span> <span class="li-normal">choices: secp256r1, secp384r1, secp521r1</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_ec_name</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[secp256r1]</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_scep_https_ca</span> - PEM format https CA Certificate. Source vpn.certificate.ca.name. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_https_ca</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_keysize</span> - Key size: 1024, 1536, 2048, 4096 . <span class="li-normal">type: str</span> <span class="li-normal">choices: 1024, 1536, 2048, 4096</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_keysize</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[1024]</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_scep_keytype</span> - Key type <span class="li-normal">type: str</span> <span class="li-normal">choices: rsa, ec</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_keytype</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[rsa]</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">apcfg_auto_cert_scep_password</span> - SCEP server challenge password for auto-regeneration. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_password</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_sub_fully_dn</span> - Full DN of the subject (e.g C=US,ST=CA,L=Sunnyvale,O=Fortinet,OU=Dep1,emailAddress=test@example.com). There should be no space in between the attributes. Supported DN attributes (case-sensitive) are:C,ST,L,O,OU,emailAddress. The CN defaults to the device"s SN and cannot be changed. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_sub_fully_dn</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_subject_alt_name</span> - Subject alternative name (optional, e.g. "DNS:dns1.com,IP:192.168.1.99") <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_subject_alt_name</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">apcfg_auto_cert_scep_url</span> - SCEP server URL. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>apcfg_auto_cert_scep_url</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">ipsec_offload</span> - Enable/disable data channel IPSec offloading . <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">lw_profile</span> - LoRaWAN profile name. Source wireless-controller.lw-profile.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">type</span> - WTP, FortiAP or AP platform type. There are built-in WTP profiles for all supported FortiAP models. You can select a built-in profile and customize it or create a new profile. <span class="li-normal">type: str</span> <span class="li-normal">choices: AP-11N, 421E, 423E, 221E, 223E, 431F, 431FL, 432F, 432FR, 433F, 433FL, 231F, 231FL, 234F, 23JF, 831F, 231G, 233G, 234G, 431G, 432G, 433G, 221K, 231K, 231KD, 23JK, 222KL, 241K, 243K, 244K, 441K, 435K, 443K, U431F, U433F, U231F, U234F, U432F, U231G, MVP, C24JE, 222E, 224E, 231E, 321E, U421E, U422EV, U423E, U221EV, U223EV, U24JEV, U321EV, U323EV, 432K, 220B, 210B, 222B, 112B, 320B, 11C, 14C, 223B, 28C, 320C, 221C, 25D, 222C, 224D, 214B, 21D, 24D, 112D, 223C, 321C, C220C, C225C, C23JD, S321C, S322C, S323C, S311C, S313C, S321CR, S322CR, S323CR, S421E, S422E, S423E, S221E, S223E, U441G</span>
 ...
 <tr>
 <td>[C24JE]</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.6.7</code></td>
 </tr>
 <tr>
 <td>[222E]</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.6.7</code></td>
 ...
 <td>[231E]</td>
 <td><code class="docutils literal notranslate">v6.2.0 -> v6.2.0</code></td>
 <td><code class="docutils literal notranslate">v6.2.5 -> v7.6.7</code></td>
 </tr>
 <tr>
 <td>[321E]</td>
 <td><code class="docutils literal notranslate">v6.2.0 -> v7.6.7</code></td>
 </tr>
 <tr>
 <td>[U421E]</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.6.7</code></td>
 ...
 <tr>
 <td>[432K]</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> v7.6.6</code></td>
 </tr>
 <tr>
 <td>[220B]</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.4 -> v7.2.4</code></td>
        ...
        <li> <span class="li-head">poe_mode</span> - Set the WTP, FortiAP, or AP"s PoE mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: auto, 8023af, 8023at, power-adapter, full, high, high-pse, low</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">ai_darrp_support</span> - Enable/disable support for FortiAIOps to retrieve Distributed Automatic Radio Resource Provisioning (DARRP) data through REST API calls . <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">cca_threshold</span> - Configure Clear Channel Assessment (CCA) threshold in dBm (-94 to -11). <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">set_80211mc</span> - Enable/disable radio 802.11mc capability . <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7</code></td>
            ...
            <li> <span class="li-head">vap_status</span> - Enable/disable all configured SSIDs on this radio . <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>

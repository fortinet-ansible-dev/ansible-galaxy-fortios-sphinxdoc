...
.. raw:: html
    ...
    <li> <span class="li-head">log_threat_weight</span> - Configure threat weight settings. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">malware_detected</span> - Threat weight score for detected malware. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, low, medium, high, critical</span></li>

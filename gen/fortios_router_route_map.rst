...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify router feature and route_map category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">router_route_map</span> - Configure route maps. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">rule</span> - Rule. <span class="li-normal">type: list</span></li>
            ...
            <li> <span class="li-head">match_vrf</span> - Match VRF ID. <span class="li-normal">type: int</span></li>

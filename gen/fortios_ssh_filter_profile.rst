...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify ssh_filter feature and profile category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">ssh_filter_profile</span> - SSH filter profile. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">block</span> - SSH blocking options. <span class="li-normal">type: str</span> <span class="li-normal">choices: x11, shell, exec, port-forward, tun-forward, sftp, scp, unknown</span></li>
        ...
        <li> <span class="li-head">log</span> - SSH logging options. <span class="li-normal">type: str</span> <span class="li-normal">choices: x11, shell, exec, port-forward, tun-forward, sftp, scp, unknown</span></li>

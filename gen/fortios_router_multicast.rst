...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify router feature and multicast category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">router_multicast</span> - Configure router multicast. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">interface</span> - PIM interfaces. <span class="li-normal">type: list</span></li>
            ...
            <li> <span class="li-head">rpf_nbr_fail_back</span> - Enable/disable fail back for RPF neighbor query. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>
            <li> <span class="li-head">rpf_nbr_fail_back_filter</span> - Filter for fail back RPF neighbors. Source router.access-list.name. <span class="li-normal">type: str</span></li>

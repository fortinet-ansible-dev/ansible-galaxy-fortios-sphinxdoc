...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">custom_log_format</span> - Customized format for logs. Source log.custom-format.name. <span class="li-normal">type: str</span>

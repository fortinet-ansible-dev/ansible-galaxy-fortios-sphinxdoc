...
.. raw:: html
    ...
    <li> <span class="li-head">ips_global</span> - Configure IPS global parameter. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">packet_log_queue_depth</span> - Packet/pcap log queue depth per IPS engine. <span class="li-normal">type: int</span></li>
        ...
        <li> <span class="li-head">socket_size</span> - IPS socket buffer size. Max and default value depend on available memory. Can be changed to tune performance. <span class="li-normal">type: int</span></li>

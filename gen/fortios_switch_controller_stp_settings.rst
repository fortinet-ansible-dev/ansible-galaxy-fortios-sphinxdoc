...
.. _fortios_switch_controller_stp_settings:
...
.. raw:: html
    ...
    <li><span class="li-head">switch_controller_stp_settings</span> - Configure FortiSwitch spanning tree protocol (STP). <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify extender_controller feature and extender category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">extender_controller_extender</span> - Extender controller configuration. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">ifname</span> - FortiExtender interface name. Source system.interface.name. <span class="li-normal">type: str</span></li>

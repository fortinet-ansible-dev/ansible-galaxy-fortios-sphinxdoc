...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ssl_settings</span> - Configure SSL VPN. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">ssl_big_buffer</span> - Disable use of the big SSLv3 buffer feature to save memory and force higher security. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>
        ...
        <li> <span class="li-head">sslv3</span> - sslv3 <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>

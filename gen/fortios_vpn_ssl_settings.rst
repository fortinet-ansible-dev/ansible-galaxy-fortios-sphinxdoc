...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">banned_cipher</span> - Select one or more cipher technologies that cannot be used in SSL-VPN negotiations. <span class="li-normal">type: list</span> <span class="li-normal">choices: RSA, DH, DHE, ECDH, ECDHE, DSS, ECDSA, AES, AESGCM, CAMELLIA, 3DES, SHA1, SHA256, SHA384, STATIC, CHACHA20, ARIA, AESCCM</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">saml_redirect_port</span> - SAML local redirect port in the machine running FCT (0 - 65535). 0 is to disable redirection on FGT side. <span class="li-normal">type: int</span>
      ...
      - name: Configure SSL VPN.
        fortios_vpn_ssl_settings:
          ...
          vpn_ssl_settings:
            ...
            saml_redirect_port: "64"
            servercert: "<your_own_value> (source vpn.certificate.local.name)"
            source_address:
             -
                name: "default_name_67 (source firewall.address.name firewall.addrgrp.name)"
            source_address_negate: "enable"
            source_address6:
             -
            ...
            source_interface:
             -
                name: "default_name_73 (source system.interface.name system.zone.name)"
            ...
            tunnel_ipv6_pools:
             -
                name: "default_name_89 (source firewall.address6.name firewall.addrgrp6.name)"
            tunnel_user_session_timeout: "90"

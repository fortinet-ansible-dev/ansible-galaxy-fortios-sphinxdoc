...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">asymroute6</span> - Enable/disable IPv6 asymmetric routing. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">asymroute6_icmp</span> - Enable/disable ICMPv6 asymmetric routing. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gui_advanced_switch_features</span> - Enable/disable advanced switching features on the GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>gui_advanced_switch_features</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gui_policy_custom_tags</span> - Enable/disable Allow configuring custom tags for polices on the GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.4.4</code></td>
        ...
        <li> <span class="li-head">gui_reverse_connector</span> - Enable/disable Enable ZTNA Reverse Proxy Connector on the GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">ike_extra_ports</span> - Extra UDP ports for the IKE daemon to listen on other than 500 and 4500 (maximum 3). <span class="li-normal">type: list</span> </li>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">ike_proposal_visibility</span> - Enable/disable display only recommended proposals in IPsec tunnel configuration. <span class="li-normal">type: str</span> <span class="li-normal">choices: recommended, all</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">ike_tcp_service</span> - Enable/disable IKE TCP service. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">ike_tls_service</span> - Enable/disable IKE TLS service. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">lan_extension_controller_port</span> - Controller port to connect. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>lan_extension_controller_port</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">src_check_reply</span> - Enable/disable source verification for reply packets. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">vrf_local_ip_isolation</span> - Enable/disable VRF local IP address isolation. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>

...
.. raw:: html
    ...
    <li><span class="li-head">system_alias</span> - Configure alias command. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">command</span> - Command list to execute. <span class="li-normal">type: str</span></li>
            <li><span class="li-head">name</span> - Alias command name. <span class="li-required">required</span> <span class="li-normal">type: str</span>
            </ul>

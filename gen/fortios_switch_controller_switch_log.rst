...
.. _fortios_switch_controller_switch_log:
...
.. raw:: html
    ...
    <li><span class="li-head">switch_controller_switch_log</span> - Configure FortiSwitch logging (logs are transferred to and inserted into FortiGate event log). <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ipsec_manualkey_interface</span> - Configure IPsec manual keys. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">npu_offload</span> - Enable/disable offloading IPsec VPN manual key sessions to NPUs. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">auto_firmware_upgrade_day</span> - Allowed day(s) of the week to start automatic patch-level firmware upgrade from FortiGuard. <span class="li-normal">type: list</span> <span class="li-normal">choices: sunday, monday, tuesday, wednesday, thursday, friday, saturday</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">proxy_server_ip</span> - Hostname or IP address of the proxy server. <span class="li-normal">type: str</span>

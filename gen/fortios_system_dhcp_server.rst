...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">template</span> - DHCP template associated with the server. Source system.dhcp.template.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">template_subnet</span> - Configure template subnet. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>template_subnet</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">template_subnet_from_interface</span> - Use interface subnet as DHCP template subnet. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>template_subnet_from_interface</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[disable]</td>

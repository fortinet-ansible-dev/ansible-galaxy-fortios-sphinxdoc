...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">enc_algorithm</span> - Enable and set the SSL security level for for sending encrypted logs to FortiCloud. <span class="li-normal">type: str</span> <span class="li-normal">choices: high_medium, high, low</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">upload_option</span> - Configure how log messages are sent to FortiCloud. <span class="li-normal">type: str</span> <span class="li-normal">choices: store_and_upload, realtime, 1_minute, 5_minute</span>

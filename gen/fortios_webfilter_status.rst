...
.. raw:: html
    ...
    <li> <span class="li-head">webfilter_status</span> - Display rating info. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">refresh_rate</span> - Frequency to refresh the server list (sec). <span class="li-normal">type: str</span>

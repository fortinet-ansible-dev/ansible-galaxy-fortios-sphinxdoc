...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Device Name. (Please note that configurations to np6_0 will apply to all NP6s.) <span class="li-normal">type: str</span> <span class="li-required">required: true</span>

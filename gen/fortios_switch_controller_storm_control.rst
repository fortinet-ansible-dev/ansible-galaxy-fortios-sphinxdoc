...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify switch_controller feature and storm_control category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_storm_control</span> - Configure FortiSwitch storm control. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">

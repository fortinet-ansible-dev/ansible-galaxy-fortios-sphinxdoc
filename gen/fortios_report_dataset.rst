...
.. raw:: html
    ...
    <li><span class="li-head">report_dataset</span> - Report dataset configuration. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">
            ...
            <li><span class="li-head">field</span> - Fields. <span class="li-normal">type: list</span></li>
                    ...
                    <li><span class="li-head">id</span> - Field ID (1 to number of columns in SQL result). <span class="li-required">required</span> <span class="li-normal">type: int</span></li>
                    <li><span class="li-head">name</span> - Name. <span class="li-normal">type: str</span> <span class="li-normal">type:</span> Field type. <span class="li-normal">type: str</span> <span class="li-normal">choices: text,  integer,  double</span>
                    </ul>
            ...
            <li><span class="li-head">parameters</span> - Parameters. <span class="li-normal">type: list</span></li>
                    ...
                    <li><span class="li-head">id</span> - Parameter ID (1 to number of columns in SQL result). <span class="li-required">required</span> <span class="li-normal">type: int</span>
                    </ul>

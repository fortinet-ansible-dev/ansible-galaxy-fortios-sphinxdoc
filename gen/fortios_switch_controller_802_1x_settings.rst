...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">link_down_auth</span> - Interface-reauthentication state to set if a link is down. <span class="li-normal">type: str</span> <span class="li-normal">choices: set_unauth, no_action</span>

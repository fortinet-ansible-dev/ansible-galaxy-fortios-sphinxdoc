:source: fortios_system_mem_mgr.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_mem_mgr</span> - Configure memory manager. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">mass_mmsd</span> - memory limit for Mass MMS Daemon (% of free memory) <span class="li-normal">type: int</span>

...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.6.0 </code></td>
        ...
        <li> <span class="li-head">ztna_proxy</span> - IPv4 ZTNA traffic forward proxy. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ztna_proxy:name</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - ZTNA Traffic Forward Proxy name. Source ztna.traffic-forward-proxy.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>

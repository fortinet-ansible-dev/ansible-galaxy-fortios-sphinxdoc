...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">access_proxy</span> - Access Proxy. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: access_proxy:name</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">proxy</span> - Type of explicit proxy. <span class="li-normal">type: str</span> <span class="li-normal">choices: explicit-web, transparent-web, ftp, ssh, ssh-tunnel, wanopt, access-proxy</span>
      ...
      - name: Configure proxy policies.
        fortios_firewall_proxy_policy:
          ...
          firewall_proxy_policy:
            ...
            dstaddr:
             -
                name: "default_name_17 (source firewall.address.name firewall.addrgrp.name firewall.proxy-address.name firewall.proxy-addrgrp.name firewall.vip
                  .name firewall.vipgrp.name firewall.vip46.name firewall.vipgrp46.name system.external-resource.name)"
            dstaddr_negate: "enable"
            dstaddr6:
             -
                name: "default_name_20 (source firewall.address6.name firewall.addrgrp6.name firewall.vip6.name firewall.vipgrp6.name firewall.vip64.name firewall
            ...
            internet_service_custom:
             -
                name: "default_name_32 (source firewall.internet-service-custom.name)"
            internet_service_custom_group:
             -
                name: "default_name_34 (source firewall.internet-service-custom-group.name)"
            internet_service_group:
             -
                name: "default_name_36 (source firewall.internet-service-group.name)"
            internet_service_id:
             -
                id:  "38 (source firewall.internet-service.id)"
            internet_service_name:
             -
                name: "default_name_40 (source firewall.internet-service-name.name)"
            ...
            poolname:
             -
                name: "default_name_50 (source firewall.ippool.name)"
            ...
            service:
             -
                name: "default_name_61 (source firewall.service.custom.name firewall.service.group.name)"
            service_negate: "enable"
            session_ttl: "63"
            spamfilter_profile: "<your_own_value> (source spamfilter.profile.name)"
            srcaddr:
             -
                name: "default_name_66 (source firewall.address.name firewall.addrgrp.name firewall.proxy-address.name firewall.proxy-addrgrp.name system
                  .external-resource.name)"
            srcaddr_negate: "enable"
            srcaddr6:
             -
                name: "default_name_69 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
            srcintf:
             -
                name: "default_name_71 (source system.interface.name system.zone.name)"
            ...
            users:
             -
                name: "default_name_78 (source user.local.name)"
            utm_status: "enable"
            uuid: "<your_own_value>"
            ...
            ztna_ems_tag:
             -
                name: "default_name_90 (source firewall.address.name firewall.addrgrp.name)"

...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ocvpn</span> - Configure One-Click VPN settings. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        <li> <span class="li-head">poll_interval</span> - OCVPN polling interval. <span class="li-normal">type: int</span></li>
        <li> <span class="li-head">status</span> - Enable/disable One-Click cloud assisted VPN. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>
...
.. code-block:: yaml+jinja
    ...
    - hosts: fortigates
      ...
      tasks:
      - name: Configure One-Click VPN settings.
        fortios_vpn_ocvpn:
          vdom:  "{{ vdom }}"
          vpn_ocvpn:
            poll_interval: "3"

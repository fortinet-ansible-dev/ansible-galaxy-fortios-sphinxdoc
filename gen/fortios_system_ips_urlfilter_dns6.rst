...
.. _fortios_system_ips_urlfilter_dns6:
...
.. raw:: html
    ...
    <li><span class="li-head">system_ips_urlfilter_dns6</span> - Configure IPS URL filter IPv6 DNS servers. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">address6</span> - IPv6 address of DNS server. <span class="li-required">required</span> <span class="li-normal">type: str</span></li>

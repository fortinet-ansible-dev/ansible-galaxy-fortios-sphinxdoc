...
.. raw:: html
    ...
    <li><span class="li-head">system_sms_server</span> - Configure SMS server for sending SMS messages to support user authentication. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">mail_server</span> - Email-to-SMS server domain name. <span class="li-normal">type: str</span></li>
            <li><span class="li-head">name</span> - Name of SMS server. <span class="li-required">required</span> <span class="li-normal">type: str</span>
            </ul>

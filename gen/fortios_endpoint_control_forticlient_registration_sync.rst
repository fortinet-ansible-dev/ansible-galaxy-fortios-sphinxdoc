...
.. _fortios_endpoint_control_forticlient_registration_sync:
...
.. raw:: html
    ...
    <li><span class="li-head">endpoint_control_forticlient_registration_sync</span> - Configure FortiClient registration synchronization settings. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">state</span> - B(Deprecated) Starting with Ansible 2.9 we recommend using the top-level 'state' parameter. HORIZONTALLINE Indicates whether to create or remove the object. <span class="li-normal">type: str</span> <span class="li-required">required: false</span> <span class="li-normal">choices: present,  absent</span></li>
            <li><span class="li-head">peer_ip</span> - IP address of the peer FortiGate for endpoint license synchronization. <span class="li-normal">type: str</span></li>

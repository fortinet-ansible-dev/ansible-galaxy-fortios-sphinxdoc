...
.. raw:: html
    ...
    <li> <span class="li-head">endpoint_control_forticlient_registration_sync</span> - Configure FortiClient registration synchronization settings. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">peer_name</span> - Peer name. <span class="li-normal">type: str</span></li>
        </ul>
    </ul>

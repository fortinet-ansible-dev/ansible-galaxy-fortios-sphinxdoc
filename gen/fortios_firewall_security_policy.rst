      ...
      - name: Configure NGFW IPv4/IPv6 application policies.
        fortios_firewall_security_policy:
          ...
          firewall_security_policy:
            ...
            service:
             -
                name: "default_name_72 (source firewall.service.custom.name firewall.service.group.name)"
            service_negate: "enable"
            srcaddr:
             -
                name: "default_name_75 (source firewall.address.name firewall.addrgrp.name system.external-resource.name)"
            srcaddr_negate: "enable"
            srcaddr4:
             -
                name: "default_name_78 (source firewall.address.name firewall.addrgrp.name)"
            srcaddr6:
             -
            ...
            users:
             -
                name: "default_name_89 (source user.local.name)"
            utm_status: "enable"
            uuid: "<your_own_value>"
            uuid_idx: "92"

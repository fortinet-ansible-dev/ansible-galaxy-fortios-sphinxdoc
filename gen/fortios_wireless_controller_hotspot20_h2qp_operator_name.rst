...
.. _fortios_wireless_controller_hotspot20_h2qp_operator_name:
...
.. raw:: html
    ...
    <li><span class="li-head">wireless_controller_hotspot20_h2qp_operator_name</span> - Configure operator friendly name. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">name</span> - Friendly name ID. <span class="li-required">required</span> <span class="li-normal">type: str</span></li>
            <li><span class="li-head">value_list</span> - Name list. <span class="li-normal">type: list</span></li>
                    <ul class="ul-self">

                    <li><span class="li-head">index</span> - Value index. <span class="li-required">required</span> <span class="li-normal">type: int</span></li>

...
.. raw:: html
    ...
    <li><span class="li-head">log_syslogd_filter</span> - Filters for remote system server. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

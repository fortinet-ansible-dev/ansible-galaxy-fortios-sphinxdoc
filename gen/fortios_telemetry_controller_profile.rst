...
-----------------------------
Supported Version Ranges: v7.6.3 -> v8.0.0
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.6.3 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">interval</span> - Time in milliseconds to check the application (60 * 1000 - 86,400 * 1000). <span class="li-normal">type: int</span>

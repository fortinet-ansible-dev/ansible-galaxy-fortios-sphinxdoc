...
.. raw:: html
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">exempt</span> - If action is set to exempt, select the security profile operations that exempt URLs skip. Separate multiple options with a space. <span class="li-normal">type: list</span> <span class="li-normal">choices: av, web_content, activex_java_cookie, dlp, fortiguard, range_block, pass, all, antiphish</span>

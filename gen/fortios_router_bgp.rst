...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify router feature and bgp category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
          ...
          router_bgp:
            ...
            neighbor_group:
             -
                ...
                additional_path: "send"
                additional_path6: "send"
                adv_additional_path: "155"
                adv_additional_path6: "156"
                advertisement_interval: "157"
                allowas_in: "158"
                allowas_in_enable: "enable"
                allowas_in_enable6: "enable"
                allowas_in6: "161"
                ...
                holdtime_timer: "190"
                interface: "<your_own_value> (source system.interface.name)"
                keep_alive_timer: "192"
                link_down_failover: "enable"
                local_as: "194"
                local_as_no_prepend: "enable"
                local_as_replace_as: "enable"
                maximum_prefix: "197"
                maximum_prefix_threshold: "198"
                maximum_prefix_threshold6: "199"
                maximum_prefix_warning_only: "enable"
                maximum_prefix_warning_only6: "enable"
                maximum_prefix6: "202"

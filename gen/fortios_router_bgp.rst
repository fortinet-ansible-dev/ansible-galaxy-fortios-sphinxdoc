          ...
          router_bgp:
            ...
            neighbor:
             -
                ...
                ip: "<your_own_value>"
                keep_alive_timer: "111"
                link_down_failover: "enable"
                local_as: "113"
                local_as_no_prepend: "enable"
                local_as_replace_as: "enable"
                maximum_prefix: "116"
                maximum_prefix_threshold: "117"
                maximum_prefix_threshold6: "118"
            ...
            neighbor_group:
             -
                ...
                additional_path: "send"
                additional_path6: "send"
                adv_additional_path: "164"
                adv_additional_path6: "165"
                advertisement_interval: "166"
                allowas_in: "167"
                allowas_in_enable: "enable"
                allowas_in_enable6: "enable"
                allowas_in6: "170"
                ...
                holdtime_timer: "199"
                interface: "<your_own_value> (source system.interface.name)"
                keep_alive_timer: "201"
                link_down_failover: "enable"
                local_as: "203"
                local_as_no_prepend: "enable"
                local_as_replace_as: "enable"
                maximum_prefix: "206"
                maximum_prefix_threshold: "207"
                maximum_prefix_threshold6: "208"
                maximum_prefix_warning_only: "enable"
                maximum_prefix_warning_only6: "enable"
                maximum_prefix6: "211"
                name: "default_name_212"
                next_hop_self: "enable"
                next_hop_self_rr: "enable"
                next_hop_self_rr6: "enable"
                next_hop_self6: "enable"

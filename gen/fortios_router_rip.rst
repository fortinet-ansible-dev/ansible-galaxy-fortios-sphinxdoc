...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify router feature and rip category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">router_rip</span> - Configure RIP. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">distance</span> - distance <span class="li-normal">type: list</span></li>
            ...
            <li> <span class="li-head">prefix</span> - Distance prefix. <span class="li-normal">type: str</span></li>
            </ul>

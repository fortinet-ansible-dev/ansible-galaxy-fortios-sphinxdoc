...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">analytics_ignore_mpip</span> - Do not submit files matching this DLP label to FortiSandbox (post-transfer scan only). Source dlp.label.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v7.0.1</code></td>
            ...
            <li> <span class="li-head">av_scan</span> - Enable/disable AntiVirus scan service. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, block, monitor</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">external_blocklist</span> - Enable/disable external-blocklist. Analyzes files including the content of archives. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, block, monitor</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">malware_stream</span> - Enable/disable 0-day malware-stream scanning. Analyzes files including the content of archives. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, block, monitor</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v6.4.4</code></td>
            ...
            <li> <span class="li-head">outbreak_prevention</span> - Enable/disable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, block, monitor, disabled, files, full-archive</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.8 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">fortisandbox_destination</span> - FortiSandbox destination options. <span class="li-normal">type: str</span> <span class="li-normal">choices: auto, sandbox, sandbox-cloud</span>
 ...
 <tr>
 <td>fortisandbox_destination</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[auto]</td>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">outbreak_prevention_error_action</span> - Action to take if outbreak-prevention encounters an error <span class="li-normal">type: str</span> <span class="li-normal">choices: log-only, block, ignore</span>
 ...
 <tr>
 <td>outbreak_prevention_error_action</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[log-only]</td>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">outbreak_prevention_timeout_action</span> - Action to take if outbreak-prevention encounters a request timeout <span class="li-normal">type: str</span> <span class="li-normal">choices: log-only, block, ignore</span>
 ...
 <tr>
 <td>outbreak_prevention_timeout_action</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[log-only]</td>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">websocket</span> - Configure WEBSOCKET AntiVirus options. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">archive_block</span> - Select the archive types to block. <span class="li-normal">type: list</span> <span class="li-normal">choices: encrypted, corrupted, partiallycorrupted, multipart, nested, mailbomb, timeout, unhandled</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">archive_log</span> - Select the archive types to log. <span class="li-normal">type: list</span> <span class="li-normal">choices: encrypted, corrupted, partiallycorrupted, multipart, nested, mailbomb, timeout, unhandled</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">outbreak_prevention</span> - Enable/disable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, block, monitor</span>

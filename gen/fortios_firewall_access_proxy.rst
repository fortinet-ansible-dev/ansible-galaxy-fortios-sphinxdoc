...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">api_gateway</span> - Set API Gateway. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: api_gateway:id</span>

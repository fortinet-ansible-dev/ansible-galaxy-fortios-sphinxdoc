...
.. raw:: html
    ...
    <li> <span class="li-head">system_ha</span> - Configure HA. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">ha_direct</span> - Enable/disable using ha-mgmt interface for syslog, SNMP, remote authentication (RADIUS), FortiAnalyzer, FortiManager and FortiSandbox. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">nac_segment</span> - VLAN for NAC segemnt primary interface. Source switch-controller.initial-config.template.name. <span class="li-normal">type: str</span>

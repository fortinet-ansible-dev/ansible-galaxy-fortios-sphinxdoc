...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">protocol</span> - Protocols used to monitor the server. <span class="li-normal">type: list</span> <span class="li-normal">choices: ping, tcp_echo, udp_echo, http, twamp, ping6</span>

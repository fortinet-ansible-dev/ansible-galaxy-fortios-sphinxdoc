...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify application feature and group category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">application_group</span> - Configure firewall application groups. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">category</span> - Application category ID list. <span class="li-normal">type: list</span></li>
            <ul class="ul-self">
        ...
        <li> <span class="li-head">name</span> - Application group name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span></li>

...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">min_change_characters</span> - Minimum number of unique characters in new password which do not exist in old password (This attribute overrides reuse-password if both are enabled). <span class="li-normal">type: int</span>

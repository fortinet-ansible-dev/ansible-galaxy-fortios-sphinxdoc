...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify system feature and password_policy_guest_admin category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_password_policy_guest_admin</span> - Configure the password policy for guest administrators. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        <li> <span class="li-head">apply_to</span> - Guest administrator to which this password policy applies. <span class="li-normal">type: str</span> <span class="li-normal">choices: guest-admin-password</span></li>

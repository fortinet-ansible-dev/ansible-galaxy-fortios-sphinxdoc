...
-----------------------------
Supported Version Ranges: v6.4.0 -> v8.0.0
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">duplication</span> - Create SD-WAN duplication rules. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: duplication:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">members</span> - Member sequence number list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: duplication:id/members:seq_num</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">update_bgp_route</span> - Enable/disable updating the BGP route. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">billing_start_day</span> - Volume billing start day when this member"s volume usgage will begin to calculate. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">duplication_threshold_bandwidth</span> - Configure duplication threshold bandwidth interface in the SD-WAN. <span class="li-normal">type: str</span> <span class="li-normal">choices: overlay, underlay</span>
 ...
 <tr>
 <td>duplication_threshold_bandwidth</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[overlay]</td>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">duplication_threshold_bibandwidth</span> - Bandwidth bistream threshold value in kilobytes per second (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>duplication_threshold_bibandwidth</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">duplication_threshold_dwbandwidth</span> - Bandwidth downstream threshold value in kilobytes per second (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>duplication_threshold_dwbandwidth</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">duplication_threshold_upbandwidth</span> - Bandwidth upstream threshold value in kilobytes per second (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>duplication_threshold_upbandwidth</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">overage</span> - Enable/disable the volume overage when member"s volume usage reaches quota-limit. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">overage_cost</span> - Cost value for this member when its volume is over quota and overage is enabled(0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">overage_volume_ratio</span> - Volume ratio value for this member when its volume is over quota and overage is enabled(1 - 255). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>overage_volume_ratio</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">overage_weight</span> - Weight value for this member when its volume is over quota and overage is enabled. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">quota_limit</span> - Volume quota limit assigned to this member in gigabytes (0 - 10485760). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">neighbor</span> - Create SD-WAN neighbors from BGP neighbor table to control route advertisements according to SLA status. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: neighbor:ip</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.4 -> 8.0.0</code></td>
            ...
            <li> <span class="li-head">bandwidth_type</span> - Overlay/underlay bandwidth-type. <span class="li-normal">type: str</span> <span class="li-normal">choices: overlay, underlay</span>

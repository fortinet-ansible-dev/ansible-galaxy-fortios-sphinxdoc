...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">app_perf_log_period</span> - Time interval in seconds that applicationperformance logs are generated (0 - 3600). <span class="li-normal">type: int</span>

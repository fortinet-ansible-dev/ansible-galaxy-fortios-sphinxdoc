...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify switch_controller feature and flow_tracking category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_flow_tracking</span> - Configure FortiSwitch flow tracking and export via ipfix/netflow. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">level</span> - Configure flow tracking level. <span class="li-normal">type: str</span> <span class="li-normal">choices: vlan, ip, port, proto</span></li>

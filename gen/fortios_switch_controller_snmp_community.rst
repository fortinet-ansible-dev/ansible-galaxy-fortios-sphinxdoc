...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">events</span> - SNMP notifications (traps) to send. <span class="li-normal">type: list</span> <span class="li-normal">choices: cpu_high, mem_low, log_full, intf_ip, ent_conf_change</span>

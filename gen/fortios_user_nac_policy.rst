...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">match_period</span> - Duration in hours to retain the matched devices (0 - 3072, 0 = always retain). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">port_setting_override</span> - Enable/disable port setting action on the NAC policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">qos_policy</span> - Switch Port qos-policy action to be applied on the matched NAC policy. Source switch-controller.qos.qos-policy.name. <span class="li-normal">type: str</span>

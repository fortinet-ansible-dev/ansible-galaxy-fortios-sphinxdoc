...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">scope</span> - Override either the specific user, user group, IPv4 address, or IPv6 address. <span class="li-normal">type: str</span> <span class="li-normal">choices: user, user_group, ip, ip6</span>

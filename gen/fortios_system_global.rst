...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify system feature and global category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_global</span> - Configure global attributes. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">admin_http_connection_receive_timeout</span> - Receive timeout for HTTP(s) connectivity to the FortiGate administrative GUI (1 - 60 seconds). <span class="li-normal">type: int</span></li>
        ...
        <li> <span class="li-head">fortitoken_cloud_service</span> - Enable/disable FortiToken Cloud service. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span></li>
        ...
        <li> <span class="li-head">vdom_mode</span> - Enable/disable support for split/multiple virtual domains (VDOMs). <span class="li-normal">type: str</span> <span class="li-normal">choices: no-vdom, split-vdom, multi-vdom</span></li>
      ...
      - name: Configure global attributes.
        fortios_system_global:
          ...
          system_global:
            ...
            sys_perf_log_interval: "159"
            tcp_halfclose_timer: "160"
            tcp_halfopen_timer: "161"
            tcp_option: "enable"
            tcp_timewait_timer: "163"
            tftp: "enable"
            timezone: "01"
            traffic_priority: "tos"
            traffic_priority_level: "low"
            two_factor_email_expiry: "168"
            two_factor_fac_expiry: "169"
            two_factor_ftk_expiry: "170"
            two_factor_ftm_expiry: "171"
            two_factor_sms_expiry: "172"
            udp_idle_timer: "173"
            user_server_cert: "<your_own_value> (source certificate.local.name)"
            vdom_mode: "no-vdom"
            vip_arp_range: "unlimited"
            virtual_server_count: "177"
            virtual_server_hardware_acceleration: "disable"
            wad_affinity: "<your_own_value>"
            wad_csvc_cs_count: "180"
            wad_csvc_db_count: "181"
            wad_memory_change_granularity: "182"
            wad_source_affinity: "disable"
            wad_worker_count: "184"

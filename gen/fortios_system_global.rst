      ...
      - name: Configure global attributes.
        fortios_system_global:
          ...
          system_global:
            ...
            admin_lockout_duration: "12"
            admin_lockout_threshold: "13"
            admin_login_max: "14"
            ...
            admin_sport: "20"
            admin_ssh_grace_time: "21"
            admin_ssh_password: "enable"
            admin_ssh_port: "23"
            admin_ssh_v1: "enable"
            admin_telnet: "enable"
            admin_telnet_port: "26"
            admintimeout: "27"
            ...
            batch_cmdb: "enable"
            block_session_timer: "45"
            br_fdb_max_entry: "46"
            cert_chain_max: "47"
            cfg_revert_timeout: "48"
            cfg_save: "automatic"
            ...
            max_dlpstat_memory: "136"
            max_route_cache_size: "137"
            mc_ttl_notchange: "enable"
            memory_use_threshold_extreme: "139"
            memory_use_threshold_green: "140"
            memory_use_threshold_red: "141"
            miglog_affinity: "<your_own_value>"
            miglogd_children: "143"
            ...
            proxy_worker_count: "163"
            radius_port: "164"
            reboot_upon_config_restore: "enable"
            refresh: "166"
            remoteauthtimeout: "167"
            ...
            sys_perf_log_interval: "203"
            tcp_halfclose_timer: "204"
            tcp_halfopen_timer: "205"
            tcp_option: "enable"
            tcp_rst_timer: "207"
            tcp_timewait_timer: "208"
            tftp: "enable"
            timezone: "01"
            tp_mc_skip_policy: "enable"
            traffic_priority: "tos"
            traffic_priority_level: "low"
            two_factor_email_expiry: "214"
            two_factor_fac_expiry: "215"
            two_factor_ftk_expiry: "216"
            two_factor_ftm_expiry: "217"
            two_factor_sms_expiry: "218"
            udp_idle_timer: "219"
            url_filter_affinity: "<your_own_value>"
            url_filter_count: "221"
            user_device_store_max_devices: "222"
            user_device_store_max_unified_mem: "223"
            user_device_store_max_users: "224"
            user_server_cert: "<your_own_value> (source certificate.local.name)"
            vdom_admin: "enable"
            vdom_mode: "no-vdom"
            vip_arp_range: "unlimited"
            virtual_server_count: "229"
            virtual_server_hardware_acceleration: "disable"
            wad_affinity: "<your_own_value>"
            wad_csvc_cs_count: "232"
            wad_csvc_db_count: "233"
            wad_memory_change_granularity: "234"
            wad_source_affinity: "disable"
            wad_worker_count: "236"

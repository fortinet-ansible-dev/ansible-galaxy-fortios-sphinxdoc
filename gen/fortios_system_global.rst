...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">admin_http_json_request_limit</span> - HTTP JSON request body size limit in bytes (0 will disable the limit). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_json_request_limit</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> v7.6.7 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">admin_http_login_request_size_limit</span> - HTTP login request body size limit in bytes. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_login_request_size_limit</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> v7.6.7 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">admin_http_rate_limit_exempt_auth</span> - Enable/disable exemption of authenticated administrator sessions from rate limiting. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>admin_http_rate_limit_exempt_auth</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">admin_http_rate_limit_max_requests</span> - Maximum number of HTTP requests that are allowed to be made in a second by a single client (0 will disable rate limiting). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_rate_limit_max_requests</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">admin_http_request_body_timeout</span> - Authenticated HTTP request body timeout, in milliseconds (0 will disable the timeout). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_request_body_timeout</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">admin_http_request_header_timeout</span> - HTTP request header timeout, in milliseconds (0 will disable the timeout). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_request_header_timeout</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">admin_http_unauthenticated_request_body_timeout</span> - Unauthenticated HTTP request body timeout, in milliseconds, before authentication (0 will disable the timeout). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>admin_http_unauthenticated_request_body_timeout</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 ...
 <tr>
 <td>bfd_affinity</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.6.7 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">geoip_full_db</span> - When enabled, the full geographic database will be loaded into the kernel which enables geographic information in traffic logs - required for FortiView countries. Disabling this option will conserve memory. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gtpu_dynamic_source_port</span> - Enable/disable GTP-U dynamic source port support. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>gtpu_dynamic_source_port</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gui_custom_theme</span> - Custom theme that overrides the default FortiGate themes. Source system.theme.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gui_login_request_rate_limit</span> - Conifgure number of login requests to maintain in the request queue (0 - 30). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>gui_login_request_rate_limit</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">gui_restrict_theme_change</span> - Enable/disable restricting editing and assigning override themes to super admins. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>gui_restrict_theme_change</td>
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
 </tr>
 <tr>
 <td>[enable]</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">http_request_limit</span> - HTTP request body size limit. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>http_request_limit</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">http_unauthenticated_request_limit</span> - HTTP request body size limit before authentication. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>http_unauthenticated_request_limit</td>
 <td><code class="docutils literal notranslate">v7.6.7 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v7.2.4 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">internet_service_database</span> - Configure which Internet Service database size to download from FortiGuard and use. <span class="li-normal">type: str</span> <span class="li-normal">choices: mini, standard, on-demand, full</span>
 ...
 <tr>
 <td>[full]</td>
 <td><code class="docutils literal notranslate">v7.0.4 -> v7.6.7</code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">log_daemon_cpu_threshold</span> - Configure syslog daemon process spawning threshold. Use a percentage threshold of syslogd CPU usage (1 - 99) or set to zero to use dynamic scheduling based on the number of packets in the syslogd queue . <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>log_daemon_cpu_threshold</td>
 <td><code class="docutils literal notranslate">v7.6.5 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">log_fsck_timeout</span> - Configure the maximum the number of seconds the FortiGate unit waits while the file system check is in progress before allowing the boot process to complete and the system fully is operational.  Zero seconds means the FortiGate unit waits until the file system check is complete (0 - 3600). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0</code></td>
        ...
        <li> <span class="li-head">private_data_encryption</span> - Enable/disable private data encryption using an AES 128-bit key or passphrase. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v8.0.0 -> 8.0.0 </code></td>
            ...
            <li> <span class="li-head">split_mode</span> - The configuration mode for the split port interface. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, 4x10G, 4x25G, 4x50G, 8x50G, 4x100G, 2x200G, 8x25G</span>
 ...
 <td>ssd_trim_date</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.4.1 </code></td>
 <td><code class="docutils literal notranslate">v7.4.3 -> 8.0.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v7.2.4 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">tcp_congestion_control</span> - Configure TCP congestion control algorithm . <span class="li-normal">type: str</span> <span class="li-normal">choices: cubic, bbr</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 8.0.0 </code></td>
        ...
        <li> <span class="li-head">wad_worker_dev_cache</span> - Number of cached devices for each ZTNA proxy worker. The default value is tuned by memory consumption. Set the option to 0 to disable the cache. <span class="li-normal">type: int</span>

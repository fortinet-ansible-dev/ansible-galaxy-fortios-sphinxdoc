...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">gui_theme</span> - Color scheme for the administration GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: green, red, blue, melongene, mariner, neutrino, jade, graphite, retro, dark-matter, onyx, eclipse</span>
      ...
      - name: Configure global attributes.
        fortios_system_global:
          ...
          system_global:
            ...
            max_dlpstat_memory: "127"
            max_route_cache_size: "128"
            mc_ttl_notchange: "enable"
            memory_use_threshold_extreme: "130"
            memory_use_threshold_green: "131"
            memory_use_threshold_red: "132"
            miglog_affinity: "<your_own_value>"
            miglogd_children: "134"
            ...
            proxy_worker_count: "153"
            radius_port: "154"
            reboot_upon_config_restore: "enable"
            refresh: "156"
            remoteauthtimeout: "157"
            ...
            sys_perf_log_interval: "190"
            tcp_halfclose_timer: "191"
            tcp_halfopen_timer: "192"
            tcp_option: "enable"
            tcp_rst_timer: "194"
            tcp_timewait_timer: "195"
            tftp: "enable"
            timezone: "01"
            tp_mc_skip_policy: "enable"
            traffic_priority: "tos"
            traffic_priority_level: "low"
            two_factor_email_expiry: "201"
            two_factor_fac_expiry: "202"
            two_factor_ftk_expiry: "203"
            two_factor_ftm_expiry: "204"
            two_factor_sms_expiry: "205"
            udp_idle_timer: "206"
            url_filter_affinity: "<your_own_value>"
            url_filter_count: "208"
            user_device_store_max_devices: "209"
            user_device_store_max_users: "210"
            user_server_cert: "<your_own_value> (source certificate.local.name)"
            vdom_admin: "enable"
            vdom_mode: "no-vdom"
            vip_arp_range: "unlimited"
            virtual_server_count: "215"
            virtual_server_hardware_acceleration: "disable"
            wad_affinity: "<your_own_value>"
            wad_csvc_cs_count: "218"
            wad_csvc_db_count: "219"
            wad_memory_change_granularity: "220"
            wad_source_affinity: "disable"
            wad_worker_count: "222"

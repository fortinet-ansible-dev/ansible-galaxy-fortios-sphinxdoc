...
.. raw:: html
    ...
    <li> <span class="li-head">log_fortianalyzer_override_setting</span> - Override FortiAnalyzer settings. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">enc_algorithm</span> - Enable/disable sending FortiAnalyzer log data with SSL encryption. <span class="li-normal">type: str</span> <span class="li-normal">choices: high-medium, high, low, disable</span></li>

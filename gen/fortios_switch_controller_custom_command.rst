...
.. _fortios_switch_controller_custom_command:
...
.. raw:: html
    ...
    <li><span class="li-head">switch_controller_custom_command</span> - Configure the FortiGate switch controller to send custom commands to managed FortiSwitch devices. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">
            ...
            <li><span class="li-head">command_name</span> - Command name called by the FortiGate switch controller in the execute command. <span class="li-normal">type: str</span> description: Description. <span class="li-normal">type: str</span>
            </ul>

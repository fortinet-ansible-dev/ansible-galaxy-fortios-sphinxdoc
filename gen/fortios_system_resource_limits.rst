...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify system feature and resource_limits category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_resource_limits</span> - Configure resource limits. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">firewall_policy</span> - Maximum number of firewall policies (IPv4, IPv6, policy46, policy64, DoS-policy4, DoS-policy6, multicast). <span class="li-normal">type: int</span></li>

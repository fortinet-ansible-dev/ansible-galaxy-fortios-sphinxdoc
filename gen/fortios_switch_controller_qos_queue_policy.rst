...
.. _fortios_switch_controller_qos_queue_policy:
...
.. raw:: html
    ...
    <li><span class="li-head">switch_controller_qos_queue_policy</span> - Configure FortiSwitch QoS egress queue policy. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">cos_queue</span> - COS queue configuration. <span class="li-normal">type: list</span></li>
                    <ul class="ul-self">
     description: Description of the COS queue. <span class="li-normal">type: str</span></li>
                    ...
                    <li><span class="li-head">max_rate</span> - Maximum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span></li>
                    <li><span class="li-head">min_rate</span> - Minimum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span></li>
                    <li><span class="li-head">name</span> - Cos queue ID. <span class="li-required">required</span> <span class="li-normal">type: str</span></li>
                    <li><span class="li-head">weight</span> - Weight of weighted round robin scheduling. <span class="li-normal">type: int</span>
                    </ul>

            <li><span class="li-head">name</span> - QoS policy name <span class="li-required">required</span> <span class="li-normal">type: str</span></li>

...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify system feature and csf category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_csf</span> - Add this FortiGate to a Security Fabric or set up a new Security Fabric on this FortiGate. <span class="li-normal">type: dict</span></li>
        ...
        <li> <span class="li-head">fabric_device</span> - Fabric device configuration. <span class="li-normal">type: list</span></li>
            ...
            <li> <span class="li-head">https_port</span> - HTTPS port for fabric device. <span class="li-normal">type: int</span></li>
        ...
        <li> <span class="li-head">fabric_object_unification</span> - Fabric CMDB Object Unification <span class="li-normal">type: str</span> <span class="li-normal">choices: default, local</span></li>

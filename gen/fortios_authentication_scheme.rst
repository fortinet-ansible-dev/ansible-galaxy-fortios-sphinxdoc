...
.. _fortios_authentication_scheme:
...
.. raw:: html
    ...
    <li><span class="li-head">authentication_scheme</span> - Configure Authentication Schemes. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">
            ...
            <li><span class="li-head">name</span> - Authentication scheme name. <span class="li-required">required</span> <span class="li-normal">type: str</span></li>
            ...
            <li><span class="li-head">user_database</span> - Authentication server to contain user information; "local" (default) or "123" (for LDAP). <span class="li-normal">type: list</span></li>
                    ...
                    <li><span class="li-head">name</span> - Authentication server name. Source system.datasource.name user.radius.name user.tacacs+.name user.ldap.name user.group.name. <span class="li-required">required</span> <span class="li-normal">type: str</span>
                    </ul>

...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify system feature and proxy_arp category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.4.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_proxy_arp</span> - Configure proxy-ARP. <span class="li-normal">type: dict</span></li>
        <ul class="ul-self">
        <li> <span class="li-head">end_ip</span> - End IP of IP range to be proxied. <span class="li-normal">type: str</span></li>
        ...
        <li> <span class="li-head">ip</span> - IP address or start IP to be proxied. <span class="li-normal">type: str</span></li>
        </ul>
    </ul>

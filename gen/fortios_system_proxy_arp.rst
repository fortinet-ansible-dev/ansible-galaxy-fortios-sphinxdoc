...
.. raw:: html
    ...
    <li><span class="li-head">system_proxy_arp</span> - Configure proxy-ARP. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

            <li><span class="li-head">end_ip</span> - End IP of IP range to be proxied. <span class="li-normal">type: str</span></li>
            <li><span class="li-head">id</span> - Unique integer ID of the entry. <span class="li-required">required</span> <span class="li-normal">type: int</span></li>

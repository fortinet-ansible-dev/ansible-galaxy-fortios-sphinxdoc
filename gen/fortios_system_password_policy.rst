...
.. _fortios_system_password_policy:
...
.. raw:: html
    ...
    <li><span class="li-head">system_password_policy</span> - Configure password policy for locally defined administrator passwords and IPsec VPN pre-shared keys. <span class="li-normal">default: null</span> <span class="li-normal">type: dict</span></li>
            <ul class="ul-self">

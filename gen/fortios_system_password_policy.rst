...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">apply_to</span> - Apply password policy to administrator passwords or IPsec pre-shared keys or both. Separate entries with a space. <span class="li-normal">type: list</span> <span class="li-normal">choices: admin_password, ipsec_preshared_key</span>

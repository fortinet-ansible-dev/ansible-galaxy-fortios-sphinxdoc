...
.. raw:: html
    ...
    <li><span class="li-head">selectors</span> - selectors list allows to pass more than one selector and its parameters in the same task.<span class="li-normal">type: list</span></li>
